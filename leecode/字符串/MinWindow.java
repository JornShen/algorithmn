...
class Solution {
    // 考虑个数
    private Map<Character, List<Integer>> map = new HashMap<>(); //　存放每个字符所在的位置的集合，为了方便统计数目．
...
//　以上是本人的写法，　算法复杂度有点高，　核心集合是 list，　关注该集合的最小的位置。
...
// cnt['.']＝１为当前的左边节点，　<0 部分值为重复的超过需要的次数。　在核心步骤会体现出的作用，跳过字母相应的次数
// 算法比较精妙